...
function AddTopic() {
  ...
  useEffect(() => {
    if (data && data.length > 0) {
      ...
      setFinalList([
        ...finalList,
        { myText: data[0], myAction: data[1], points: data[2] },
      ]);
    }
  ...
  return (
    <>
      <Header></Header>
      <div className="mt-5 ourContainer">
        <div className="row ">
          <div className="col-5">
          ...
          {/* move to dashboard */}
          <div className="col-3">
            <Link to="/dashboard" className="removeUnderline">
              <h3>Dashboard</h3>
            </Link>
          </div>
        </div>
        ...
        <div className="row">
          ...
          <div className="col-10">
            <div>
              ...
              {/* Button */}
              <button
                className="landingButton item-width"
                onClick={() => {
                ...
                ? selectedText.map((i, index) => (
                    <span key={index}>
                      ...
                      {finalList && finalList.length > 0
                        ? finalList.map((i, index) => console.log(index + 1, i))
                        : []}
                    </span>
                  ))
                : []}
